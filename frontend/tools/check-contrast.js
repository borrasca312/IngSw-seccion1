...
const patterns = [
  { regex: /bg-input\s+text-card-foreground/, message: 'Inputs with bg-input and text-card-foreground (should use input-scout bg-white text-gray-900 or collapse to CSS rule)' },
  { regex: /placeholder:text-muted-foreground/, message: 'Placeholder uses muted foreground; this can be low contrast on white' },
  { regex: /text-card-foreground/, message: 'text-card-foreground used; if text sits on white background it will be low contrast' }
];
