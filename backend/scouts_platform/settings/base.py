...
# Permitir logs en formato JSON usando env LOG_JSON=true
USE_JSON_LOGS = os.getenv("LOG_JSON", "").lower() in ("1", "true", "yes")
LOG_FORMATTER_NAME = "json" if USE_JSON_LOGS else "verbose"
...
# Sentry (monitorización de errores). Inicializa si está disponible la DSN.
try:
    from .sentry import init_sentry as _init_sentry

    _init_sentry()
except Exception:  # pragma: no cover
    # Evita romper la app si falta la dependencia o variables en desarrollo local
    pass
