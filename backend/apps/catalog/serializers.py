...
class ProvinciaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Provincia
        fields = ['codigo', 'nombre', 'region', 'region_nombre', 'is_active', 'created_at']
        read_only_fields = ['created_at']
...
class ComunaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comuna
        fields = [
            'codigo', 'nombre', 'provincia', 'provincia_nombre', 
            'region_nombre', 'is_active', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class ZonaSerializer(serializers.ModelSerializer):
    region_principal_nombre = serializers.CharField(
        source='region_principal.nombre', 
        read_only=True
    )
    ...
    class Meta:
        model = Zona
        fields = [
            'codigo', 'nombre', 'descripcion', 'region_principal', 
            'region_principal_nombre', 'is_active', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class DistritoSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Distrito
        fields = [
            'codigo', 'nombre', 'zona', 'zona_nombre', 
            'descripcion', 'is_active', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class GrupoScoutSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = GrupoScout
        fields = [
            'codigo', 'nombre', 'distrito', 'distrito_nombre', 'zona_nombre',
            'comuna', 'comuna_nombre', 'direccion', 'telefono', 'email',
            'fecha_fundacion', 'is_active', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class RamaSerializer(serializers.ModelSerializer):
    class Meta:
        model = Rama
        fields = [
            'codigo', 'nombre', 'descripcion', 'edad_minima', 'edad_maxima',
...
class TipoCursoSerializer(serializers.ModelSerializer):
    class Meta:
        model = TipoCurso
        fields = [
            'codigo', 'nombre', 'descripcion', 'duracion_default_horas',
            'precio_sugerido', 'is_active', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class NivelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Nivel
        fields = [
            'codigo', 'nombre', 'descripcion', 'orden', 'rama',
            'rama_nombre', 'is_active', 'created_at'
        ]
        read_only_fields = ['created_at']
...
class TipoAlimentacionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            'codigo', 'nombre', 'descripcion', 'es_restriccion', 
