...
class CourseListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = [
            'id', 'title', 'code', 'category_name', 'rama', 'status',
            'price', 'max_participants', 'available_slots', 
            'start_date', 'end_date', 'is_enrollment_open'
        ]
...
class CourseDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Course
        fields = [
            'id', 'title', 'description', 'code', 'category', 'category_id',
            'rama', 'status', 'price', 'max_participants', 'available_slots',
            'start_date', 'end_date', 'is_enrollment_open', 'team_members',
