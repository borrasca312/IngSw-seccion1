...
class CourseAdmin(admin.ModelAdmin):
    list_display = ('code', 'title', 'modality', 'status', 'start_date', 'end_date', 'capacity_info', 'course_actions')
    ...
    fieldsets = (
        ...
        ('Capacidad y Costos', {
            'fields': ('max_participants', 'min_participants', 'price', 'early_bird_price', 'early_bird_deadline')
        }),
        ('Requisitos', {
    ...
    def course_actions(self, obj):
        ...
        try:
            preinscription_url = reverse('admin:preinscriptions_preinscription_changelist') + f'?course={obj.id}'
            actions.append(f'<a href="{preinscription_url}" title="Ver preinscripciones" style="text-decoration:none;">👥</a>')
        except:
            pass
        
        # Ver pagos
        try:
            payment_url = reverse('admin:payments_payment_changelist') + f'?course={obj.id}'
            actions.append(f'<a href="{payment_url}" title="Ver pagos" style="text-decoration:none;">💰</a>')
        except:
            pass
        ...
        if obj.id:
            ...
            actions.append(f'<a href="{frontend_url}" target="_blank" title="Ver en frontend" style="text-decoration:none;">🌐</a>')
