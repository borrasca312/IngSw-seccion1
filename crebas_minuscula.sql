...
Tabla que registra los tipos de alimentaci�';
...
Tabla que registra todos los m�dulos del si';
...
Tabla que registra la aliimentaci�n que hab';
...
(
   ...
   cuu_tipo             int not null  comment '1: Con Almuerzo
             ...
             Se realaciona con ALI_TIPO (Alimentaci�n)',
...
(
   ...
   peu_estado           int not null  comment '1: Pre Inscripci�n
             2: Avisado
             3: Lista de Espera
             4: Inscrito
             5: Vigente
